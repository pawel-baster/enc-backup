...
from src.numberNameManager import NumberNameManager
...
class AlternativeBackupJobAndNumberManager(unittest.TestCase):

    def setUp(self):        
        self.root = os.path.dirname( __file__ )  + os.path.sep + 'fixtures' + os.path.sep + 'AlternativeBackupJobAndNumberManager' + os.path.sep
